...
- `docs/CONFIGURATION_AND_CALIBRATION_TH.md`: axis parameters, travel, speed, homing และ PEND commissioning
- `docs/TESTING_AND_TROUBLESHOOTING_TH.md`: read-only diagnostics และวิธีวิเคราะห์ Home/Jog/Limit/Slot/ALM/PEND
