...
อัปเดตสถานะเอกสาร: 14 กันยายน 2026

เอกสารในโฟลเดอร์นี้อธิบายระบบ HMI, Controller, IRIV I/O และ STM32 NUCLEO-G491RE สำหรับเครื่องจริง ก่อนใช้ข้อมูลด้านสายไฟหรือความปลอดภัยต้องตรวจเทียบกับเครื่อง As-Built เสมอ
