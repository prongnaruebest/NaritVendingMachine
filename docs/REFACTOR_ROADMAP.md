...
- [ ] Complete operator, configuration, PEND, testing and troubleshooting manuals. (release/rollback and current Operator HMI manuals complete; configuration/PEND/testing deep guides remain)
