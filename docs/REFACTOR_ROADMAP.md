...
- [ ] Extract router and lifecycle-safe page controllers. (read-only pages, Slots table, Motion Selected Slot, Visualization, Demo Sampling and System Control complete; Motion controls remain incremental)
