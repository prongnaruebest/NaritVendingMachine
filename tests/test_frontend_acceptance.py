...
class FrontendAcceptanceTests(unittest.TestCase):
    ...
    def test_io_status_separates_picontrol_from_iriv_modbus(self) -> None:
        ...
        self.assertIn('key: "x_pend", channel: 2, pin: 27', APP_JS)
        self.assertIn('key: "y_pend", channel: 3, pin: 22', APP_JS)
        self.assertIn("piInputs.x_alarm === true || piInputs.y_alarm === true", APP_JS)
