...
(() => {
  ...
  function create(options) {
    ...
    const onSaveSequence = () => invoke(options.onSaveSequenceSettings);
    ...
    function mount() {
      ...
      const sequenceToggle = document.getElementById("slot-mgr-sequence-toggle");
      const saveSequenceBtn = document.getElementById("save-slot-sequence-btn");
      ...
      saveSequenceBtn?.addEventListener("click", onSaveSequence);
      options.render();
      return () => {
        ...
        saveSequenceBtn?.removeEventListener("click", onSaveSequence);
      };
    }
